...
void greetings(){
    ...
    if (time-> tm_hour < 12){
        cout<< "Good Morning shubham"<<endl;
        string phrase = "Good Morning shubham";
        ...
        cout<< "Good Afternoon shubham"<<endl;
        string phrase = "Good Afternoon shubham";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
        ...
        cout<< "Good Evening shubham"<<endl;
        string phrase = "Good Evening shubham";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    {
        cout<<"******************************************************"<<endl;
        cout<<"| ENTER THE PASSWORD TO CONFIRM YOU ARE shubham|"<<endl;
        cout<<"******************************************************"<<endl<<endl;
        string phrase = "ENTER THE PASSWORD TO CONFIRM YOU ARE shubham";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        ...
        if(password=="shubham")
        {
            ...
            do{
                ...
                {
                    cout<<"I'm a personal assistant created by shubham !!!"<<endl;
                    string phrase = "I'm a personal assistant created by shubham !!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout<<"Good Bye shubham, see you soon!"<<endl;
                    string phrase = "Good Bye shubham, see you soon!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
